...
def run_easyeda2kicad_from_file(input_file, output_dir="./lib/CyberCard", python_path="../../.venv/bin/python"):
...
if __name__ == "__main__":
        ...
        output_path = sys.argv[2] if len(sys.argv) > 2 else "./lib/CyberCard"
